...
<div class="main">
		...
		<div id="content">
			...
			<h2 style="text-shadow: 0 0 4px black; color:#4CAF50;  text-align:center; text-decoration:blink; font:18pt Impact; ">
			  ...
			  <a href="fine_student.php" class="i_button">Fine Of Student</a>
			  <a href="fine_date.php" class="i_button">Fine List By Date</a>
			  <a href="fine_list_month.php" class="i_button">Fine List By Month</a>

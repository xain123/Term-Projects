<?php
	...
	$errors = array();
	$message ="";
		$query = "select student_id  ,concat(student_first_name,' ',student_last_name) as student,current_semester
		          from student ";
...
<div class="main">
		...
		<div id="content">
			...
			<table>
					...
					?>
					<tr>
						<td><?php echo ucfirst($display['student_id']); ?></td>
						<td><?php echo ucfirst($display['student']); ?></td>
						<td><?php echo ucfirst($display['current_semester']); ?></td>
					</tr>
					<?php
							}
						}

<?php
	...
	if(isset($_POST['submit']))
	{
		...
		//1
		$fields_required =array( "book_isbn", "book_edition", "book_name", "author_Fname", "author_Lname", "book_category");
		...
		$fields_with_max_lengths = array( "book_isbn" => 11, "book_edition" => 50, "book_name" => 50, 
		...
		validate_max_lengths($fields_with_max_lengths);
			...
			{
				$errors["category"]="Add Category First.";
			}
		...
		//if(!$res1)
		{
			...
			$query="select author_id 
							from author 
							where author_first_name='$a_fname' and author_last_name='$a_lname'";
			...
			$query5="insert into book(status_id,isbn) 
								values(2,$isbn)";
		...
		<div id="content">
			...
			<div class="addbook">
					<form action="Add_book.php" method ="post">
						...
						Book Category:		<select   class="inputs"  type="text" name="book_category" /><br />
						<?php 

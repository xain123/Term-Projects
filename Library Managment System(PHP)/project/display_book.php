...
<div class="main">
		...
		<div id="content">
			...
			<h2 style="text-shadow: 0 0 4px black; color:#4CAF50;  text-align:center; text-decoration:blink; font:18pt Impact; ">
			  ...
			  <a href="display_by_category.php" class="i_button">Category</a>
			  <a href="display_by_issued.php" class="i_button">Issued Books</a>
			  <a href="display_by_teacher.php" class="i_button">Issued To Teacher</a>
			  <a href="display_by_student.php" class="i_button">Issued To Student</a>

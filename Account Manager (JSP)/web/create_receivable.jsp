...
<html lang="en">
  <head>
    ...
    <title>Account Reveivable</title>
...
<% 
    ...
    <div class="row">
      ...
      <div class ="container">
          <div class="col-sm-offset-5  col-md-5" style="padding-top: 20px">
           
           <form action="createReceivableServlet" onsubmit="return creat_recevable();" method="post" id ="rform" class ="form-horizontal " role="form">  
            <fieldset class="scheduler-border">
              <legend class="scheduler-border">Create Account Receivable</legend>
                ...
                <div class="form-group">
                  <div class="col-sm-offset-0 col-md-11">
                    <input type="txt" placeholder="CNIC" class="form-control" id ="cnic" name ="cnic1" >
                  </div>
                </div>

                <div class="form-group">
                  <div class="col-sm-offset-0 col-md-11">
                    <input type="Txt" placeholder="Address" class="form-control" id="add" name="add1">
                  </div>
                </div>
                <div class="form-group">
                  <div class="col-sm-offset-0 col-md-11">
                    <input type="Txt" placeholder="Email" class="form-control" id="email" name="email1" >
                  </div>
                </div>
                <div class="form-group">
                  <div class="col-sm-offset-0 col-md-11">
                    <input type="Number" placeholder="Amount Receivable" class="form-control" id ="receivable" name ="receivable" >
                  </div>
                </div>
                <div class="form-group">
                  <div class="col-sm-offset-0 col-md-11">

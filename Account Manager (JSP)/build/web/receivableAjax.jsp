...
<%   
           int recev_id = Integer.parseInt(request.getParameter("id"));         
          int amount = Integer.parseInt(request.getParameter("amount"));
           String date = request.getParameter("date");
           System.out.println("sss" + recev_id + " " +amount + " " + date );
           ...
           int  amount3 =Integer.parseInt(rs.getString("amount_recev"));
           ...
           String sql_query1 = "UPDATE account_receivable SET amount_recev=?, next_turn=? WHERE recev_id=?;";
